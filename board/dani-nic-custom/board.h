...
/**
 * @file
 * Board definition for the custom dani-nic board */
#ifndef BOARD_DANI_NIC_CUSTOM_BOARD_H_
#define BOARD_DANI_NIC_CUSTOM_BOARD_H_
...
/**
NRF_P0  SW_pin  DANI-NIC-CUSTOM        Notes (recommended usage)
------------------------------------------------------------------------
P0.00    0      gpio/LED-1
P0.01    1      gpio/LED-2
P0.02    2      gpio
...
#endif /* BOARD_DANI_NIC_CUSTOM_BOARD_H_ */
